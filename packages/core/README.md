...
- `src/chat/diagnostics-panel.svelte` — collapsed runtime diagnostics for instruction sources, policy state, hooks/patterns/verifiers, threads, and completion artifacts
