...
- Benchmark sources:
  - `packages/sdk/tests/Framework_Testing_Suite/word-agent-benchmark-suite-split/core-suite.json`
  - `packages/sdk/tests/Framework_Testing_Suite/word-agent-benchmark-suite-split/adversarial-suite.json`
  - `packages/sdk/tests/Framework_Testing_Suite/word-agent-benchmark-suite-split/run-live-word-benchmark.mjs`
  - `packages/sdk/tests/Framework_Testing_Suite/word-agent-benchmark-suite-split/summarize-word-benchmark.mjs`
  - `packages/sdk/tests/Framework_Testing_Suite/word-agent-benchmark-suite-split/word-agent-capability-benchmark-spec.md`
  - `packages/sdk/tests/Framework_Testing_Suite/word-agent-benchmark-suite-split/word-agent-harness-validation-spec.md`
